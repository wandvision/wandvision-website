/* ===================================================
   ...
   CSS je u zasebnom fajlu: konfigurator-modal.css
   
   Verwendung:
     <link rel="stylesheet" href="konfigurator-modal.css">
     <script src="konfigurator-modal.js" defer></script>
...
var KonfiguratorModal = (function() {
  ...
  // CSS is now in konfigurator-modal.css — loaded via <link> in <head>
    ...
    '<div class="km-card">' +
      ...
      '<div class="km-step" data-step="8">' +
        '<div class="km-success">' +
          ...
          '</div>' +
          '<p class="km-contact-heading">Oder kontaktieren Sie uns direkt</p>' +
          ...
          '</div>' +
          '<button class="km-btn-primary km-btn-success-close" onclick="KonfiguratorModal.close()">' +
  ...
  function init() {
    ...
    // CSS is loaded via <link rel="stylesheet" href="konfigurator-modal.css"> in <head>
